IF DB_ID('Identity') IS NULL CREATE DATABASE [Identity];
GO
USE [Identity];
GO
...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20260518012525_InitialCreate'
)
BEGIN
...
BEGIN
    CREATE TABLE [EventLogs] (
        ...
        [SourceService] nvarchar(max) NOT NULL,
...
BEGIN
    CREATE TABLE [LibraryCards] (
        ...
        CONSTRAINT [FK_LibraryCards_AspNetUsers_UserId] FOREIGN KEY ([UserId]) REFERENCES [AspNetUsers] ([Id]) ON DELETE CASCADE
    );
END;
...
BEGIN
    CREATE UNIQUE INDEX [IX_LibraryCards_UserId] ON [LibraryCards] ([UserId]);
END;
...
BEGIN
    ...
    VALUES (N'20260518012525_InitialCreate', N'10.0.8');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260518022541_UpdateDatabase'
)
BEGIN
...
BEGIN
    ALTER TABLE [LibraryCards] DROP CONSTRAINT [FK_LibraryCards_AspNetUsers_UserId];
END;
...
BEGIN
    ALTER TABLE [LibraryCards] ADD CONSTRAINT [FK_LibraryCards_Users_UserId] FOREIGN KEY ([UserId]) REFERENCES [Users] ([Id]) ON DELETE CASCADE;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260518022541_UpdateDatabase', N'10.0.8');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260518024624_UpdateModelsSchema'
)
BEGIN
...
BEGIN
    ALTER TABLE [LibraryCards] ADD [IsActive] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [EventLogs] ADD [CreatedAt] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';
END;
...
BEGIN
    ALTER TABLE [EventLogs] ADD [IsActive] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [EventLogs] ADD [UpdatedAt] datetime2 NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260518024624_UpdateModelsSchema', N'10.0.8');
END;
